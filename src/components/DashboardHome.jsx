...
// Landing page for the internal dashboard.
...
const DashboardHome = ({ user }) => {
  ...
  return (
    <div className="p-4 bg-deepGray text-offWhite min-h-full rounded-xl">
      <h2 className="text-3xl font-bold text-offWhite mb-6">Welcome to Your Dashboard, {user?.displayName || user?.email || 'Staff Member'}!</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* Quick Actions Card */}
        <div className="bg-darkGray p-6 rounded-xl shadow-md border border-gray-700">
