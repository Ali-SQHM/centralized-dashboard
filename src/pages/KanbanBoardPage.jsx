...
function KanbanBoardPage({ db, firestoreAppId, currentUser }) {
  ...
  return (
    ...
    <PageLayout pageTitle="Production Kanban Board">
      {/* The main content for the Kanban Board page, now inside PageLayout */}
      <div className="flex flex-col h-full text-offWhite"> {/* Removed w-full, min-w-0 */}
